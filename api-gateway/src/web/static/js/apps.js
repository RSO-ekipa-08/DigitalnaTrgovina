...
async function loadApps() {
  try {
    ...
    appsGrid.innerHTML = data.applications
      .map(
        (app) => `
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 cursor-pointer" onclick="location.href='/app/${app.id}'">
          ...
          <div class="p-4">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">${app.name || "Unnamed App"}</h3>
            <div class="space-y-2">
